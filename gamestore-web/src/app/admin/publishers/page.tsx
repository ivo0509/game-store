...
import { listAllPublishers } from "@/services/adminService";
...
export default async function AdminPublishersPage() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
      <h1 className="text-3xl font-bold text-gray-900 mb-1">Publishers</h1>
      <p className="text-gray-600 mb-6">{publishers.length} total</p>
